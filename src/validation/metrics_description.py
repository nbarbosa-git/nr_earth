...
def  get_metrics_dicts(values):
 ...
 #OK
    ...
    #OK
    dict_AnnPayout = {"Metrica": 'Annual_Payout', 
                   "Valor": values['Annual_Payout'], 
                   "Categoria": "Financeira", 
                   "Range_Aceitavel": "[3.6%..4.4%] ", 
                   "Descricao": "Retira as 25% piores e melhores eras corr" }
    ...
    dict_std_percentile_rank = {"Metrica": 'std_percentile_rank', 
        ...
        #
    dict_tb_mean = {"Metrica": 'tb200_mean', 
                       "Valor": values['tb200_mean'], 
                       "Categoria": "TB", 
                       "Range_Aceitavel": "[..]", 
                       "Descricao": ".." }


    dict_tb_std = {"Metrica": 'tb200_std', 
                       "Valor": values['tb200_std'], 
                       "Categoria": "TB", 
                       "Range_Aceitavel": "[..]", 
                       "Descricao": ".." }
    ...
    #
    dict_tb_sharpe = {"Metrica": 'tb200_sharpe', 
                       "Valor": values['tb200_sharpe'], 
                       "Categoria": "TB", 
                       "Range_Aceitavel": "[..]", 
                       "Descricao": "" }
    ...
    dict_tb_exp_max = {"Metrica": 'tb200_max_exp_mean', 
                       "Valor": values['tb200_max_exp_mean'], 
                       "Categoria": "TB", 
                       "Range_Aceitavel": "[..]", 
                       "Descricao": "" }
