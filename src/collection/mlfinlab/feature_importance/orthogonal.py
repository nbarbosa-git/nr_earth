...
def feature_pca_analysis(feature_df, feature_importance, variance_thresh=0.95):
    ...
    df_scatter['eVec_X_eVal'] = all_eigen_values
    df_scatter['Feat_Imp'] = repeated_importance_array
    df_eVec = abs(eigen_vec * eigen_val)
    ...
    return corr_dict, df_scatter, df_eVec