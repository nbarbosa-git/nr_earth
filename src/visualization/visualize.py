...
def highlight_max_(s):
    min_cols = ["Feat_exp_max", 'Validation_SD', 'corr_with_example_preds', 'corr_with_ex_FN100', 
                ...
                'full_Std_Dev', 'easy_Std_Dev', 'hard_Std_Dev']
...
def highlight_max(s):
    ...
    min_cols = ["Feat_exp_max", 'Validation_SD', 'Live_SD','corr_with_example_preds', 'AR(1)', 'AR(1)_sign', 'Preds_Dependence', 'SD']  
...
#LEGACY
NEW_VALIDATION_METRIC_INTERVALS = {
    "Validation_Mean": (0.017, 0.031), 
    "Validation_Sharpe": (0.5, 1.5),
    "Feat_neutral_mean": (0.013, 0.022),

    "Validation_SD": (0.0303, 0.0168),
    "Feat_exp_max": (0.4, 0.0661),
    "Max_Drawdown": (-0.25, -0.04), 

    "val_mmc_mean": (-0.008, 0.008),
    "corr_plus_mmc_sharpe": (0.5, 1.5),   
    "corr_with_example_preds": (1, 0.4),
    ...
    #"validation_corr_plus_mmc_sharpe_diff": (-0.25, 0.25), 
    #"validation_corr_plus_mmc_mean": (0.017, 0.031),
